# Twitter sentiment analysis: training step
# Taken from: http://analyzecore.com/2017/02/08/twitter-sentiment-analysis-doc2vec/
# Implemented by: H. Achicanoy
# 2017

# loading packages
suppressMessages(library(twitteR))
suppressMessages(library(ROAuth))
...
setwd("./Documents/Datasets/twitter_sentiment_data/")
